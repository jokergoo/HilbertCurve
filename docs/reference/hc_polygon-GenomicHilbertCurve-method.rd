...
<li>
  ...
  <div class="col-md-9 contents">
    ...
    <div class="hidden name"><code>hc_polygon-GenomicHilbertCurve-method.rd</code></div>
    </div>
...
<span><span class="fu"><a href="hc_polygon-dispatch.html">hc_polygon</a></span><span class="op">(</span><span class="va">object</span>, <span class="va">gr</span>, gp <span class="op">=</span> <span class="fu"><a href="https://rdrr.io/r/grid/gpar.html" class="external-link">gpar</a></span><span class="op">(</span><span class="op">)</span>,</span>
<span>    end_type <span class="op">=</span> <span class="fu"><a href="https://rdrr.io/r/base/c.html" class="external-link">c</a></span><span class="op">(</span><span class="st">"average"</span>, <span class="st">"expanding"</span>, <span class="st">"shrinking"</span><span class="op">)</span><span class="op">)</span></span></code></pre></div>
    </div>
...
<dd><p>a <code><a href="https://rdrr.io/pkg/GenomicRanges/man/GRanges-class.html" class="external-link">GRanges</a></code> object which contains the genomic regions to be mapped to the curve</p></dd>
  ...
  <dt>gp</dt>
<dd><p>pass to <code><a href="hc_polygon-HilbertCurve-method.html">hc_polygon,HilbertCurve-method</a></code></p></dd>
...
<dd><p>pass to <code><a href="hc_polygon-HilbertCurve-method.html">hc_polygon,HilbertCurve-method</a></code></p></dd>
    ...
    <div id="details">
    <h2>Details</h2>
    <p>It is basically a wrapper of <code><a href="hc_polygon-HilbertCurve-method.html">hc_polygon,HilbertCurve-method</a></code>.</p>
    </div>
    <div id="value">
    <h2>Value</h2>
    

<p>Refer to <code><a href="hc_polygon-HilbertCurve-method.html">hc_polygon,HilbertCurve-method</a></code></p>
...
<span class="r-in"><span><span class="fu"><a href="hc_polygon-dispatch.html">hc_polygon</a></span><span class="op">(</span><span class="va">hc</span>, <span class="va">gr</span><span class="op">)</span></span></span>
<span class="r-plt img"><img src="hc_polygon-GenomicHilbertCurve-method-1.png" alt="" width="700" height="433"></span>
</code></pre></div>
    </div>
  </div>
