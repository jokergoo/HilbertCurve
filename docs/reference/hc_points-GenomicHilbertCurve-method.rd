...
<li>
  ...
  <div class="col-md-9 contents">
    ...
    <div class="hidden name"><code>hc_points-GenomicHilbertCurve-method.rd</code></div>
    </div>
...
<span><span class="fu"><a href="hc_points-dispatch.html">hc_points</a></span><span class="op">(</span><span class="va">object</span>, <span class="va">gr</span>,</span>
...
<dd><p>a <code><a href="https://rdrr.io/pkg/GenomicRanges/man/GRanges-class.html" class="external-link">GRanges</a></code> object which contains the genomic regions to be mapped to the curve</p></dd>
  ...
  <dt>np</dt>
<dd><p>pass to <code><a href="hc_points-HilbertCurve-method.html">hc_points,HilbertCurve-method</a></code></p></dd>

  <dt>size</dt>
<dd><p>size of points when <code>np &lt;= 1</code>, pass to <code><a href="hc_points-HilbertCurve-method.html">hc_points,HilbertCurve-method</a></code></p></dd>

  <dt>pch</dt>
<dd><p>shape of the points when <code>np &lt;= 1</code>, pass to <code><a href="hc_points-HilbertCurve-method.html">hc_points,HilbertCurve-method</a></code></p></dd>

  <dt>gp</dt>
<dd><p>graphic parameters of the points when <code>np &lt;= 1</code>, pass to <code><a href="hc_points-HilbertCurve-method.html">hc_points,HilbertCurve-method</a></code></p></dd>

  <dt>mean_mode</dt>
<dd><p>pass to <code><a href="hc_points-HilbertCurve-method.html">hc_points,HilbertCurve-method</a></code></p></dd>

  <dt>shape</dt>
<dd><p>shape of the points when <code>np &gt;= 2</code>, pass to <code><a href="hc_points-HilbertCurve-method.html">hc_points,HilbertCurve-method</a></code></p></dd>


</dl></div>
    <div id="details">
    <h2>Details</h2>
    <p>It is basically a wrapper of <code><a href="hc_points-HilbertCurve-method.html">hc_points,HilbertCurve-method</a></code>.</p>
    </div>
    <div id="value">
    <h2>Value</h2>
    

<p>Refer to <code><a href="hc_points-HilbertCurve-method.html">hc_points,HilbertCurve-method</a></code></p>
...
<span class="r-plt img"><img src="hc_points-GenomicHilbertCurve-method-1.png" alt="" width="700" height="433"></span>
</code></pre></div>
    </div>
  </div>
