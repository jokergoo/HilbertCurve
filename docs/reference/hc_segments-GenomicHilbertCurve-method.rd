...
<li>
  ...
  <div class="col-md-9 contents">
    ...
    <div class="hidden name"><code>hc_segments-GenomicHilbertCurve-method.rd</code></div>
    </div>
...
<dd><p>a <code><a href="https://rdrr.io/pkg/GenomicRanges/man/GRanges-class.html" class="external-link">GRanges</a></code> object which contains the genomic regions to be mapped to the curve</p></dd>
  ...
  <dt>gp</dt>
<dd><p>pass to <code><a href="hc_segments-HilbertCurve-method.html">hc_segments,HilbertCurve-method</a></code></p></dd>


</dl></div>
    <div id="details">
    <h2>Details</h2>
    <p>It is basically a wrapper of <code><a href="hc_segments-HilbertCurve-method.html">hc_segments,HilbertCurve-method</a></code>.</p>
    </div>
    <div id="value">
    <h2>Value</h2>
    

<p>Refer to <code><a href="hc_segments-HilbertCurve-method.html">hc_segments,HilbertCurve-method</a></code></p>
