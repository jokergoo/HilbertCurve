...
<li>
  ...
  <div class="col-md-9 contents">
    ...
    <div class="hidden name"><code>hc_text-GenomicHilbertCurve-method.rd</code></div>
    </div>
...
<span><span class="fu"><a href="hc_text-dispatch.html">hc_text</a></span><span class="op">(</span><span class="va">object</span>, <span class="va">gr</span>, <span class="va">labels</span>, gp <span class="op">=</span> <span class="fu"><a href="https://rdrr.io/r/grid/gpar.html" class="external-link">gpar</a></span><span class="op">(</span><span class="op">)</span>,</span>
...
<dd><p>a <code><a href="https://rdrr.io/pkg/GenomicRanges/man/GRanges-class.html" class="external-link">GRanges</a></code> object which contains the genomic regions to be mapped to the curve</p></dd>
  ...
  <dt>labels</dt>
<dd><p>pass to <code><a href="hc_text-HilbertCurve-method.html">hc_text,HilbertCurve-method</a></code></p></dd>

  <dt>gp</dt>
<dd><p>pass to <code><a href="hc_text-HilbertCurve-method.html">hc_text,HilbertCurve-method</a></code></p></dd>

  <dt>centered_by</dt>
<dd><p>how to define the "center" of the interval represented in Hilbert curve. Pass to <code><a href="hc_text-HilbertCurve-method.html">hc_text,HilbertCurve-method</a></code>.</p></dd>
...
<dd><p>pass to <code><a href="hc_text-HilbertCurve-method.html">hc_text,HilbertCurve-method</a></code></p></dd>
    ...
    <div id="details">
    <h2>Details</h2>
    <p>It is basically a wrapper of <code><a href="hc_text-HilbertCurve-method.html">hc_text,HilbertCurve-method</a></code>.</p>
    </div>
    <div id="value">
    <h2>Value</h2>
    

<p>Refer to <code><a href="hc_text-HilbertCurve-method.html">hc_text,HilbertCurve-method</a></code></p>
...
<span class="r-in"><span><span class="va">bed</span> <span class="op">=</span> <span class="fu"><a href="https://rdrr.io/pkg/circlize/man/generateRandomBed.html" class="external-link">generateRandomBed</a></span><span class="op">(</span>nr <span class="op">=</span> <span class="fl">20</span><span class="op">)</span></span></span>
...
<span class="r-in"><span><span class="fu"><a href="hc_text-dispatch.html">hc_text</a></span><span class="op">(</span><span class="va">hc</span>, <span class="va">gr</span>, labels <span class="op">=</span> <span class="fu"><a href="https://rdrr.io/r/base/sample.html" class="external-link">sample</a></span><span class="op">(</span><span class="va">letters</span>, <span class="fu"><a href="https://rdrr.io/pkg/BiocGenerics/man/nrow.html" class="external-link">nrow</a></span><span class="op">(</span><span class="va">bed</span><span class="op">)</span>, replace <span class="op">=</span> <span class="cn">TRUE</span><span class="op">)</span><span class="op">)</span></span></span>
<span class="r-plt img"><img src="hc_text-GenomicHilbertCurve-method-1.png" alt="" width="700" height="433"></span>
</code></pre></div>
    </div>
  </div>
