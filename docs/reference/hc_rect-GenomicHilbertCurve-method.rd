...
<li>
  ...
  <div class="col-md-9 contents">
    ...
    <div class="hidden name"><code>hc_rect-GenomicHilbertCurve-method.rd</code></div>
    </div>
...
<span><span class="fu"><a href="hc_rect-dispatch.html">hc_rect</a></span><span class="op">(</span><span class="va">object</span>, <span class="va">gr</span>, gp <span class="op">=</span> <span class="fu"><a href="https://rdrr.io/r/grid/gpar.html" class="external-link">gpar</a></span><span class="op">(</span>fill <span class="op">=</span> <span class="st">"red"</span>, col <span class="op">=</span> <span class="st">"red"</span><span class="op">)</span>,</span>
...
<dd><p>a <code><a href="https://rdrr.io/pkg/GenomicRanges/man/GRanges-class.html" class="external-link">GRanges</a></code> object which contains the genomic regions to be mapped to the curve</p></dd>
  ...
  <dt>gp</dt>
<dd><p>pass to <code><a href="hc_rect-HilbertCurve-method.html">hc_rect,HilbertCurve-method</a></code></p></dd>
...
<dd><p>pass to <code><a href="hc_rect-HilbertCurve-method.html">hc_rect,HilbertCurve-method</a></code></p></dd>
    ...
    <div id="details">
    <h2>Details</h2>
    <p>It is basically a wrapper of <code><a href="hc_rect-HilbertCurve-method.html">hc_rect,HilbertCurve-method</a></code>.</p>
    </div>
    <div id="value">
    <h2>Value</h2>
    

<p>Refer to <code><a href="hc_rect-HilbertCurve-method.html">hc_rect,HilbertCurve-method</a></code></p>
