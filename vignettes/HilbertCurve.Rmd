...
**Version**: `r installed.packages()["HilbertCurve", "Version"]`
...
<p><video   controls loop><source src="../extdata/move-on-hilbert-curve-.webm" /></video></p>
...
```{r, eval = grepl("tbi", Sys.info()["nodename"]) & Sys.info()["user"] == "guz", echo = 2:9}
...
png("gc_percent_chr1.png", width = 600, height = 600)
...
```{r, eval = grepl("tbi", Sys.info()["nodename"]) & Sys.info()["user"] == "guz", fig.keep = "none", echo = c(2:5,7:8)}
png("gc_percent_half_chr1.png", width = 600, height = 600)
...
png("H3K27ac_chr1.png", width = 600, height = 600)
...
```{r, eval = grepl("tbi", Sys.info()["nodename"]) & Sys.info()["user"] == "guz", fig.keep = "none", echo = 2}
png("H3K36me3_chr1.png", width = 600, height = 600)
...
```{r, eval = grepl("tbi", Sys.info()["nodename"]) & Sys.info()["user"] == "guz", fig.keep = "none", echo = 2}
png("H3K4me3_chr1.png", width = 600, height = 600)
...
```{r, eval = grepl("tbi", Sys.info()["nodename"]) & Sys.info()["user"] == "guz", fig.keep = "none", echo = 2}
png("H3K9me3_chr1.png", width = 600, height = 600)
...
```{r, eval = grepl("tbi", Sys.info()["nodename"]) & Sys.info()["user"] == "guz", fig.keep = "none", echo = c(1:8, 10:23)}
...
png("H3K36me3_chr1_overlap.png", width = 600, height = 600)
hc = GenomicHilbertCurve(chr = "chr1", level = 9, mode = "pixel",
...
```{r, eval = grepl("tbi", Sys.info()["nodename"]) & Sys.info()["user"] == "guz", fig.keep = "none", echo = c(1:8, 10:11)}
...
png("methylation_chr1.png", width = 600, height = 600)
hc = GenomicHilbertCurve(chr = "chr1", level = 9, mode = "pixel", legend = lgd)
...
The reason is under "pixel" mode, it is impossible to convert text directly into pixels (remember
under "pixel" mode, because the curve is stored as an RGB matrix), while if
