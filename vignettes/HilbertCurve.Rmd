...
level 11, then each pixel can represent about 60bp (``249250621/2048/2048``) which is of very high resolution.
...
x = sample(1000, 100)
hc_layer(hc, x1 = x, x2 = x, mean_mode = "absolute")
...
The map also can be added to the curve, but you need to be careful that
