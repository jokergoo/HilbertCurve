...
If the position are not integers, you can set the positions by `x1` and `x2`. These
two arguments also work for other grahical functions.

```{r, eval = FALSE}
hc = HilbertCurve(1, 100, level = 4, reference = TRUE)
hc_points(hc, x1 = c(10.5, 50.5), x2 = c(20.5, 60.5), np = 3, 
