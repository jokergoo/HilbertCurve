...
lgd3 = color_mapping_legend(cm, title = "style 3", plot = FALSE)
...
cm = ColorMapping(col_fun = col_fun)
lgd = color_mapping_legend(cm, title = "GC percent", plot = FALSE,
...
plot_histone_mark = function(mark) {
    ...
    cm2 = ColorMapping(level = c(mark, "gene"), color = c("#FF0000", "#CCCCCC"))
