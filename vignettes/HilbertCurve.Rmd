...
lgd3 = Legend(col_fun = col_fun, title = "style 3", plot = FALSE)
...
lgd = Legend(col_fun = col_fun, title = "GC percent", plot = FALSE,
...
invisible(dev.off())
# or you can only save the Hilbert curve part as a PNG file
...
plot_histone_mark = function(mark) {
    ...
    lgd = Legend(col_fun = col_fun, title = "Intensity", plot = FALSE)
    lgd2 = Legend(labels = c(mark, "gene"), legend_gp = gpar(fill = c("#FF0000", "#CCCCCC"))
        title = "Layer", plot = FALSE)
...
lgd2 = Legend(labels = c("H3K36me3", "overlap", "gene"),
    legend_gp = gpar(fill = c("#FF0000", "purple", "#CCCCCC")) title = "Layer", plot = FALSE)
...
lgd = Legend(col_fun = col_fun, title = "Methylation", plot = FALSE)
