...
\arguments{
  ...
  \item{background}{the background can be provided as a 'GenomicRanges::GRanges' object.  It is not very well supported. It assumes that all regions which will be specified in  \code{\link{hc_layer,GenomicHilbertCurve-method}} are subsets of background regions.}
